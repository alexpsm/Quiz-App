...
class TestStripePaymentCheckout:
    ...
    def test_checkout_credits_100_returns_url(self, authenticated_session):
        ...
        response = authenticated_session.post(
            ...
            json={"package_id": "credits_100", "origin_url": "https://ball-knowledge.preview.emergentagent.com"}
        )
    ...
    def test_checkout_credits_500_returns_url(self, authenticated_session):
        ...
        response = authenticated_session.post(
            f"{BASE_URL}/api/payments/checkout",
            json={"package_id": "credits_500", "origin_url": "https://ball-knowledge.preview.emergentagent.com"}
        )
        assert response.status_code == 200
        data = response.json()
        assert "url" in data
    ...
    def test_checkout_credits_1000_returns_url(self, authenticated_session):
        ...
        response = authenticated_session.post(
            f"{BASE_URL}/api/payments/checkout",
            json={"package_id": "credits_1000", "origin_url": "https://ball-knowledge.preview.emergentagent.com"}
        )
        assert response.status_code == 200
        data = response.json()
        assert "url" in data
    ...
    def test_checkout_premium_returns_url(self, authenticated_session):
        ...
        response = authenticated_session.post(
            f"{BASE_URL}/api/payments/checkout",
            json={"package_id": "premium", "origin_url": "https://ball-knowledge.preview.emergentagent.com"}
        )
        assert response.status_code == 200
        data = response.json()
        assert "url" in data
    ...
    def test_checkout_invalid_package_returns_400(self, authenticated_session):
        ...
        response = authenticated_session.post(
            f"{BASE_URL}/api/payments/checkout",
            json={"package_id": "invalid_package", "origin_url": "https://ball-knowledge.preview.emergentagent.com"}
        )
